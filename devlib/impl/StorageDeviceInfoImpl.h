...
public:
    StorageDeviceInfoImpl(
            int vid, int pid,
            QString const& filePath, QString const& serialNumber,
...
private:
    ...
    auto serialNumber_core(void) const noexcept
        -> QString  override { return _serialNumber; }
    ...
    int _vid, _pid;
    QString _filePath, _serialNumber;
